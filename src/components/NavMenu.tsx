            ...
            >
                <PopoverPanel className="absolute left-1/2 z-10 mt-5 flex w-screen lg:max-w-min -translate-x-1/2 lg:-translate-x-48">
                    <div className="w-full lg:w-56 shrink rounded-xl bg-steelGray p-4 text-sm font-semibold leading-6 text-gray-900 shadow-lg ring-1 ring-gray-900/5">
                        <p className="text-center text-white">Hola: Usuario</p>
                        <Link to="/" className="block p-2 text-white hover:scale-105 duration-300 ">
                            Agenda De Citas
                        </Link>
                        <Link to="/" className="block p-2 text-white hover:scale-105 duration-300 ">
                            Historial de Citas
                        ...
                        <button
                            className="block p-2 text-white hover:scale-105 duration-300 "
                            type="button"
                            onClick={() => {}}
                        >
                            Cerrar Sesión
